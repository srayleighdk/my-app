  ...
  return (
    <div className="bg-primaryColor px-1 pb-3">
      <div className='relative'>
        ...
        <button
          type="button"
          className="bg-[#f8ba8c] h-10 pt-1 absolute inset-y-0 right-0 flex items-center px-[14px] py-2 border border-transparent rounded-md bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
